    ...
    <table>
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td>
                <a href='editreturned.php?bookcode={$row['bookcode']}' style='color: blue; text-decoration: underline;'>Edit</a> | 
    ...
    <script>
        $(document).ready(function () {
            ...
            $(".delete-link").on("click", function (e) {
                ...
                // Get the book code from data-id attribute
                ...
                if (confirm("Are you sure you want to delete this book?")) {
                    // Make an Ajax request to deletereturned.php
                    $.ajax({
                        type: "POST",
                        url: "deletereturned.php",
                        data: {
                            bookcode: bookCode
                        },
                        dataType: "json",
