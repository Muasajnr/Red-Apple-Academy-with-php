    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($result) {
            ...
            if ($result->num_rows > 0) {
                $sql = "INSERT INTO lostbooks ( bookcode, bookname,studentname, studentadmno, bookprice) VALUES ('$bookcode','$bookname', '$studentname','$studentadmno','$bookprice')";
...
<div class="top">
    ...
    <section class="content">
        <div class="featured-content">
            ...
            <h1>List a Lost Book</h1>
            
            <form action="lostbooks.php" method="post" enctype="multipart/form-data">
            ...
            <input type="currency" name="bookprice"  required>
